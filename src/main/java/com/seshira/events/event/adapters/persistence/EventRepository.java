package com.seshira.events.event.adapters.persistence;

import com.seshira.events.event.adapters.persistence.entity.EventEntity;
import com.seshira.events.event.adapters.persistence.mappers.EventEntityMapper;
...
public class EventRepository implements SaveEventRepository, GetEventRepository, GetEventChildrenRepository, FilterEventRepository {
    ...
    public Event byId(UUID eventId) {
        var eventEntity = entityManager.find(EventEntity.class, eventId);
